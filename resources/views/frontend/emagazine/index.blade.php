...
@endforeach
                    ...
                    <!--                <img src="https://jaimansha.org/images/tazeen.jpg" />-->

                    <!--            </div>-->
                    <!--            <div class="left-magzine-data-link">-->
                    <!--                <p class="m-0 magzin-text-head">JA Pandey</p>-->
                    <!--                <p class="" style="font-size: 12px; color: #9b9999;"><i class="fa-solid fa-location-dot"></i> Mussorie</p>-->
                    <!--                <p class="button-art">View All Articals </p>-->
