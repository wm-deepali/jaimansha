...
@if(in_array(strtolower($category->author?->author_type), ['magazine', 'both']))
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="meta_description" class="form-control rich-editor" rows="2"></textarea>
                    </div>
                    <div class="mb-2">
                        <label>Slug</label>
    ...
    @method('PUT')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label>Meta Description</label>
                    <textarea id="edit-meta_description" name="meta_description" class="form-control rich-editor"></textarea>
                </div>
