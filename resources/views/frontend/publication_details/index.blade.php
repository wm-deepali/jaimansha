            ...
            <div class="col-xl-8 col-lg-7">
                <div class="service-details__left">
                    <div class="service-details__img">
                        <!--<img src="{{ asset('storage/'.$publication->image) ?? 'assets/images/services/service-details-img-3.jpg' }}" alt="{{ $publication->title }}">-->
                                            <img src="{{ asset('public/uploads/authors/' . $publication->author->image) }}" alt="{{ $publication->title }}">
                    </div>
                    <div class="service-details__content">
                        <h3 class="service-details__title-1">{{ $publication->title }}</h3>

                        <p class="service-details__text-1">{!! $publication->short_description !!}</p>

                        <p class="service-details__text-2">{!! nl2br(e($publication->long_description)) !!}</p>

                        <ul class="service-details__points list-unstyled">
                            <!-- <li>
                                <div class="icon"><span class="icon-check"></span></div>
                                <p>Our advocacy efforts aim to raise awareness & influence policy change on issues affecting our community.</p>
                            </li>
                            <li>
                                <div class="icon"><span class="icon-check"></span></div>
                                <p>We work tirelessly to ensure that every voice is heard and that necessary resources are accessible to all.</p>
                            </li> -->
                        </ul>
                        ...
                        <!-- <div class="service-details__video-img">
                            ...
                            <div class="service-details__video-link">
                                <a href="{{ $publication->video_url ?? 'https://www.youtube.com/watch?v=Get7rqXYrbQ' }}" class="video-popup">
                        ...
                        <!--<p class="service-details__text-3">Ready to start your next project? Contact us today for a consultation and detailed estimate.</p>-->
                    </div>
                </div>
            </div>
        </div>
