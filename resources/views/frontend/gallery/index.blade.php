...
<body class="custom-cursor">
    ...
    <div class="section-title text-center sec-title-animation animation-style1">
        ...
        <h2 class="section-title__title title-animation">Gallery</h2>
    </div>
    ...
    <div class="case-one__main-tab-box case-one__tabs-box">
        ...
        <ul class="case-one-tab-buttons case-one-tab-btns list-unstyled">
            <li data-tab="#allcategory" class="p-tab-btn active-btn">
        ...
        <div class="p-tabs-content">
            ...
            <div class="p-tab active-tab" id="allcategory">
                <div class="gallery-image d-flex flex-wrap gap-2">
                    @foreach($media as $item)
                        @if($item->media_type === 'image')
                            <div class="case-one__img">
                                <img
                                    src="{{ asset('public/' . $item->file_path) }}"
                                    alt="{{ $item->title }}"
                                    class="img-thumbnail img-clickable"
                                    data-bs-toggle="modal"
                                    data-bs-target="#imageModal"
                                    data-img="{{ asset('public/' . $item->file_path) }}">
                            </div>
                        @endif
                    @endforeach
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-transparent border-0">
                    <div class="modal-body text-center p-0">
                        <img id="modalImage" src="" class="img-fluid rounded shadow" alt="Modal Image">
                    </div>
                </div>
            </div>
        </div>
